...
Produce a webpage using GitHub pages and markdown that describes your investigation through the course of the semester.  Include in your final product individual sections that address the following.
...
2. Describe the **population** of your LMIC and selected administrative subdivisions.  Spatially describe the population distribution of your LMIC at the first, second and/or third administrative levels as appropriate.  Provide the results from your analysis of your LMIC's population including validation of the predicted spatial distribution of population values at different scales and your interpretation of relevant model results.  Include histograms, density plots and other supplemental information as needed.
3. Provide results from your description of **human settlements** and urban areas, **roadways** and **health care facilities**.  Include supplemental tables that describe settlements, roadways and health care facilities as well as three-dimensional plots to further support your description, analysis, interpretation and findings.  Analyze and interpret your results  in terms of the spatial distribution and size of human settlements, transportation facilities' level-of-service and health care services' accessibility.

Include with the relevants plots your interpretation and analysis as well as supplemental tables and charts that further support your findings.  If you transitioned from one country or location to another country or location due to computational or data related issues, please incorporate a justification as to why and how that transition took place.
